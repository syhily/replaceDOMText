...
(function (root, factory) {
  ...
  function Finder(node, options) {
    const preset = options.preset && exposed.PRESETS[options.preset]
  ...
  Finder.prototype = {
    ...
    search() {
      ...
      regex
        = typeof regex === 'string' ? new RegExp(escapeRegExp(regex), 'g') : regex
    ...
    getPortionReplacementNode(portion, match) {
